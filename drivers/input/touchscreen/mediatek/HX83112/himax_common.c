...
{
#include "K6312Q_HLT_kubee_CIDFF29_D00_C16_0531-013307.i"
};
#endif
...
//prize-add-pengzhipeng-20200826-start
extern bool mt_charger_plugin(void);
//prize-add-pengzhipeng-20200826-end
...
//prize-add-pengzhipeng-20200826-start
    ...
    connect_status = mt_charger_plugin();
	//prize-add-pengzhipeng-20200826-end

    ts = private_ts;
  //  printk("Touch: cable status=%d, cable_config=%p, usb_connected=%d \n", connect_status,ts->cable_config, ts->usb_connected);
    if (ts->cable_config)
    {
