...
//prize-solve fod-pengzhipeng-20210224-start
void MT5725_SetFod(void){
    vuc val;
    val.ptr[0] = 128;
    val.ptr[1] = 68;
    MT5725_write_buffer(mte,0x0078,val.ptr,2);
    val.ptr[0] = 128;
    val.ptr[1] = 76;
    MT5725_write_buffer(mte,0x007A,val.ptr,2);
    val.ptr[0] = 128;
    val.ptr[1] = 74;
    MT5725_write_buffer(mte,0x007C,val.ptr,2);
    val.ptr[0] = 128;
    val.ptr[1] = 72;
    MT5725_write_buffer(mte,0x007E,val.ptr,2);
    val.ptr[0] = 128;
    val.ptr[1] = 70;
    MT5725_write_buffer(mte,0x0080,val.ptr,2);
    val.ptr[0] = 128;
    val.ptr[1] = 70;
    MT5725_write_buffer(mte,0x0082,val.ptr,2);
}
//prize-solve fod-pengzhipeng-20210224-end
