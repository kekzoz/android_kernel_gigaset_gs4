...
#endif
#if defined(S5KGM1SPMT_MIPI_RAW)
{S5KGM1SPMT_SENSOR_ID, SENSOR_DRVNAME_S5KGM1SPMT_MIPI_RAW,S5KGM1SPMT_MIPI_RAW_SensorInit},
#endif
...
#endif
#if defined (S5K4H7YXMT_MIPI_RAW)
    {S5K4H7YXMT_SENSOR_ID, SENSOR_DRVNAME_S5K4H7YXMT_MIPI_RAW, S5K4H7YXMT_MIPI_RAW_SensorInit},
#endif
...
#endif
#if defined(IMX350MT_MIPI_RAW)
{IMX350MT_SENSOR_ID, SENSOR_DRVNAME_IMX350MT_MIPI_RAW, IMX350MT_MIPI_RAW_SensorInit},
#endif
...
#endif
#if defined(S5K3P3SXMT_MIPI_RAW)
{S5K3P3SXMT_SENSOR_ID, SENSOR_DRVNAME_S5K3P3SXMT_MIPI_RAW,S5K3P3SXMT_MIPI_RAW_SensorInit},
#endif
