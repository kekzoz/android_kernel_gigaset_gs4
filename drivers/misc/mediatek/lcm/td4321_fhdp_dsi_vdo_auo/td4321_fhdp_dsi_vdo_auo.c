...
//prize-Solve suspend current leakage 3ma-anhengxuan-20201207-start
void tpd_gpio_output(int pin, int level);
//prize-Solve suspend current leakage 3ma-anhengxuan-20201207-end
/* --------------------------------------------------------------------------- */
/* Local Constants */
/* --------------------------------------------------------------------------- */
...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.vertical_frontporch					= 8; // 4;
	params->dsi.vertical_active_line				= FRAME_HEIGHT; 

	params->dsi.horizontal_sync_active = 8;
	params->dsi.horizontal_backporch = 10;//32
	params->dsi.horizontal_frontporch = 20; // 17 //78
	params->dsi.horizontal_active_pixel = FRAME_WIDTH;
	/* params->dsi.ssc_disable                                                       = 1; */

	params->dsi.PLL_CLOCK = 520;//480; // 520;//244;
