...
//prize add by tangcong 20210611 start
#if defined(ILI7807Q_FHDP_DSI_VDO_INCELL)
	&ili7807q_fhdp_dsi_vdo_incell_lcm_drv,
#endif	
//prize add by tangcong  20210611 end
...
#if defined(FT8719_FHDP_DSI_VDO_INCELL_HLT)
	&ft8719_fhdp_dsi_vdo_incell_hlt_lcm_drv,
#endif
